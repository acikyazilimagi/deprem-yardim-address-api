...
class GoogleGeocodeAPI:
    ...
    def request(self, address):
        response = requests.get(f'https://maps.googleapis.com/maps/api/place/textsearch/json', params={"query":address.lower(), "inputtype": "textquery", "fields": "formatted_address,name,geometry", "key":self.api_key})
